# Generated by Powerlevel10k configuration wizard on 2020-03-05 at 16:20 CST.
...
# round separators, sharp heads, slanted tails, 2 lines, disconnected, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='\uE0BA'   # \uE0D7   \uE0CE i  \uE0BA 
  # The right end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL='\uE0BC'     # \uE0D6   \uE0BC 
  # The right end of right prompt.
  # Left prompt terminator for lines without any segments.
  typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=9999
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=''  # \uFB4E פֿ; \uF8D9 ; \uF1A9  , \uF054 ,  ❯
  ...
  typeset -g POWERLEVEL9K_VCS_BACKGROUND=226
  ...
  function my_git_formatter() {
    ...
    typeset -g POWERLEVEL9K_STAGE_ICON=$'\uF055 '
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${POWERLEVEL9K_VCS_PUSH_COMMITS_BEHIND_ICON}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${POWERLEVEL9K_VCS_PUSH_COMMITS_AHEAD_ICON}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${POWERLEVEL9K_STAGE_ICON}${VCS_STATUS_NUM_STAGED}"
  ...
  #######################################[ context: user]#######################################
  # user color.
  typeset -g POWERLEVEL9K_USER_BACKGROUND=202
  ...
  #######################################[ context: host]#######################################
  # host color.
  typeset -g POWERLEVEL9K_HOST_BACKGROUND=236
  ...
  function prompt_example() { 
    ...
    #     p10k segment -b 0 -f 3 -i "${content}" -t ''
    # else
